...
namespace TXTCommunication.Fischertechnik.Txt
{
    ...
    class TxtExtension
    {
        ...
        public TxtExtension(int extensionId)
        {
            ...
            MotorDirections = new FtInterface.MotorDirection[TxtInterface.MotorOutputs];
        }
        ...
        public void SetInputMode(int index, FtInterface.InputMode mode, bool isDigital)
        {
        ...
        public FtInterface.MotorDirection GetMotorDirection(int motorIndex)
        {
        ...
        public void SetMotorDirection(int motorIndex, FtInterface.MotorDirection value)
        {
            if (!OutputModes[motorIndex])
            {
                throw new InvalidOperationException($"O{motorIndex * 2} or O{motorIndex * 2 + 1} is not a motor");
        ...
        public int GetMotorValue(int motorIndex)
        {
            ...
            if (MotorDirections[motorIndex] == FtInterface.MotorDirection.Left)
            {
                return OutputValues[motorIndex * 2 + 1];
            }
            if (MotorDirections[motorIndex] == FtInterface.MotorDirection.Right)
            {
        ...
        public void SetMotorValue(int motorIndex, int value)
        {
            ...
            else if (MotorDirections[motorIndex] == FtInterface.MotorDirection.Right)
            {
