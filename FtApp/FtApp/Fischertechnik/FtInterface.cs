...
{
    public abstract class FtInterface : IDisposable
    {
        ...
        public abstract void Connect(string adress);
        ...
        /// </summary>
        public abstract void StartOnlineMode();
        ...
        public abstract string GetInterfaceVersionCode();
        ...
        public abstract int GetMotorCount();
        ...
        public abstract int GetMaxOutputValue();
        ...
        public abstract int GetMotorIndex(int outputIndex);
        ...
        /// </summary>
        public abstract event InputValueChangedEventHandler InputValueChanged;
        ...
        /// </summary>
        public abstract event OnlineStartedEventHandler OnlineStarted;
